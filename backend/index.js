...
const uri =
  "mongodb+srv://someshwarshewalkar:8l7kUYia5pQdXK10@yagaexperts.hechb.mongodb.net/?retryWrites=true&w=majority&appName=yagaExperts";
...
async function run() {
  try {
    ...
    // const database = client.db("yogaExperts");

    // Connect the client to the server
    const database = client.db("yagaExperts");
