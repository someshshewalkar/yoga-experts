  ...
  return (
    <div className="shadow-lg rounded-lg p-3 flex flex-col justify-between border border-secondary overflow-hidden m-4">
      ...
      <div className="p-4">  
        ...
        <p className="text-grey-600 mb-2">Avalaibale Seates: {availableSeats}</p>
        <p className="text-grey-600 mb-2">Price:{price}</p>
        <p className="text-grey-600 mb-2">Total Student:{totalEnrolled}</p>
